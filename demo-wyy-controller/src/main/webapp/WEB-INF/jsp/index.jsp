...
<body>
	<div>
		<input type="button" value="新增" class="btn btn-success" style="margin-left:320px;" onclick="jumpaddUser();"/>
	...
	<form class="form-inline" role="form" action="" method="post">
		<div class="form-group" style="margin-left:600px;">
			<input type="text" class="layui-input" id="user_name" name="user_name" placeholder="请输入姓名"  autocomplete="off"> 
			<select id="user_departement" name="user_departement" class="layui-input">
		...
		<input type="button" value="查询" class="btn btn-success" style="margin-left:20px;" onclick="Fuzzyquery();">
	</form>
	<!-- 模糊查询end -->
	...
	<c:forEach var="department" items="${departmentlist }">
		<table class="table table-bordered" style="text-align: center;width: 50%;">
			<%-- <tr style="text-align: center;">
				...
				<tr>
					<td style="width: 55px">部门名称</td>
					<td style="vertical-align: middle; width: 55px">${department.department_name }</td>
				</tr>
				<tr>
					<td style="width: 55px">部门负责人</td>
					<td style="vertical-align: middle; width: 55px">${department.department_user }</td>
				</tr>
				<tr>
					<td style="vertical-align: middle;width: 55px">员工</td>
					<td style="vertical-align: middle; width: 20px">
						<c:forEach var="user" items="${department.userList }">
								<p><a href="javascript:;" onclick="jumpechoUser(${user.user_id})">${user.user_name }</a></p>
						</c:forEach>
